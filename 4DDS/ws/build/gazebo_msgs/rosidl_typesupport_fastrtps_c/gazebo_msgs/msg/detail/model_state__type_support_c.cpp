...
#include "gazebo_msgs/msg/detail/model_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // model_name, reference_frame
#include "rosidl_runtime_c/string_functions.h"  // model_name, reference_frame
...
using _ModelState__ros_msg_type = gazebo_msgs__msg__ModelState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ModelState__ros_msg_type * ros_message = static_cast<const _ModelState__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _ModelState__ros_msg_type * ros_message = static_cast<_ModelState__ros_msg_type *>(untyped_ros_message);
  // Field name: model_name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _ModelState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gazebo_msgs__msg__ModelState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gazebo_msgs__msg__ModelState;
    is_plain =
      (
...
static size_t _ModelState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gazebo_msgs__msg__ModelState(
...
static message_type_support_callbacks_t __callbacks_ModelState = {
  "gazebo_msgs::msg",
  "ModelState",
