...
#include "gazebo_msgs/msg/detail/link_state__rosidl_typesupport_fastrtps_c.h"
...
using _LinkState__ros_msg_type = gazebo_msgs__msg__LinkState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LinkState__ros_msg_type * ros_message = static_cast<const _LinkState__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _LinkState__ros_msg_type * ros_message = static_cast<_LinkState__ros_msg_type *>(untyped_ros_message);
  // Field name: link_name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _LinkState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gazebo_msgs__msg__LinkState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gazebo_msgs__msg__LinkState;
    is_plain =
      (
...
static size_t _LinkState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gazebo_msgs__msg__LinkState(
...
static message_type_support_callbacks_t __callbacks_LinkState = {
  "gazebo_msgs::msg",
  "LinkState",
