  ...
  void * untyped_ros_message)
{
  ...
  _GetLinkProperties_Request__ros_msg_type * ros_message = static_cast<_GetLinkProperties_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: link_name
  {
    std::string tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _GetLinkProperties_Response__ros_msg_type * ros_message = static_cast<_GetLinkProperties_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: com
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
