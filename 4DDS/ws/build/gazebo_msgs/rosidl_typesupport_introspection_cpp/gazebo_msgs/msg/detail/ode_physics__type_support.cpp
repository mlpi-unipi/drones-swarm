...
void ODEPhysics_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) gazebo_msgs::msg::ODEPhysics(_init);
}

void ODEPhysics_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gazebo_msgs::msg::ODEPhysics *>(message_memory);
  typed_message->~ODEPhysics();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ODEPhysics_message_members = {
  ...
  ODEPhysics_init_function,  // function to initialize message memory (memory has to be allocated)
  ODEPhysics_fini_function  // function to terminate message instance (will not free memory)
};
