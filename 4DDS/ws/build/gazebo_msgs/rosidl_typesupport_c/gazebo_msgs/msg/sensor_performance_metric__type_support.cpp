...
static const _SensorPerformanceMetric_type_support_symbol_names_t _SensorPerformanceMetric_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gazebo_msgs, msg, SensorPerformanceMetric)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, msg, SensorPerformanceMetric)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gazebo_msgs, msg, SensorPerformanceMetric)() {
  return &::gazebo_msgs::msg::rosidl_typesupport_c::SensorPerformanceMetric_message_type_support_handle;
}
