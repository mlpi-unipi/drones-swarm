...
static const _ApplyBodyWrench_Request_type_support_symbol_names_t _ApplyBodyWrench_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gazebo_msgs, srv, ApplyBodyWrench_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, ApplyBodyWrench_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gazebo_msgs, srv, ApplyBodyWrench_Request)() {
  return &::gazebo_msgs::srv::rosidl_typesupport_c::ApplyBodyWrench_Request_message_type_support_handle;
}
...
static const _ApplyBodyWrench_Response_type_support_symbol_names_t _ApplyBodyWrench_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gazebo_msgs, srv, ApplyBodyWrench_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, ApplyBodyWrench_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gazebo_msgs, srv, ApplyBodyWrench_Response)() {
  return &::gazebo_msgs::srv::rosidl_typesupport_c::ApplyBodyWrench_Response_message_type_support_handle;
}
...
static const _ApplyBodyWrench_type_support_symbol_names_t _ApplyBodyWrench_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gazebo_msgs, srv, ApplyBodyWrench)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, ApplyBodyWrench)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, gazebo_msgs, srv, ApplyBodyWrench)() {
  return &::gazebo_msgs::srv::rosidl_typesupport_c::ApplyBodyWrench_service_type_support_handle;
}
