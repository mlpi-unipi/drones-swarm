...
#ifndef GAZEBO_MSGS__MSG__DETAIL__MODEL_STATES__TRAITS_HPP_
#define GAZEBO_MSGS__MSG__DETAIL__MODEL_STATES__TRAITS_HPP_
...
inline std::string to_yaml(const ModelStates & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const gazebo_msgs::msg::ModelStates & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const gazebo_msgs::msg::ModelStates & msg)
{
...
template<>
inline const char * name<gazebo_msgs::msg::ModelStates>()
{
  return "gazebo_msgs/msg/ModelStates";
}
...
template<>
struct is_message<gazebo_msgs::msg::ModelStates>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // GAZEBO_MSGS__MSG__DETAIL__MODEL_STATES__TRAITS_HPP_
