...
inline void to_flow_style_yaml(
  const ApplyBodyWrench_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: body_name
...
inline std::string to_yaml(const ApplyBodyWrench_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const gazebo_msgs::srv::ApplyBodyWrench_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const gazebo_msgs::srv::ApplyBodyWrench_Request & msg)
{
...
inline void to_flow_style_yaml(
  const ApplyBodyWrench_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: success
...
inline std::string to_yaml(const ApplyBodyWrench_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use gazebo_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const gazebo_msgs::srv::ApplyBodyWrench_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  gazebo_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use gazebo_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const gazebo_msgs::srv::ApplyBodyWrench_Response & msg)
{
  return gazebo_msgs::srv::to_yaml(msg);
}
