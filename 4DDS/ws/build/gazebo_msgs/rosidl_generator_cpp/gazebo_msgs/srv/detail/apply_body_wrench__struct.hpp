...
#ifndef GAZEBO_MSGS__SRV__DETAIL__APPLY_BODY_WRENCH__STRUCT_HPP_
#define GAZEBO_MSGS__SRV__DETAIL__APPLY_BODY_WRENCH__STRUCT_HPP_
...
struct ApplyBodyWrench_Request_
{
  ...
  explicit ApplyBodyWrench_Request_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  ...
  explicit ApplyBodyWrench_Request_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : body_name(_alloc),
...
struct ApplyBodyWrench_Response_
{
  ...
  explicit ApplyBodyWrench_Response_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit ApplyBodyWrench_Response_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
...
#endif  // GAZEBO_MSGS__SRV__DETAIL__APPLY_BODY_WRENCH__STRUCT_HPP_
