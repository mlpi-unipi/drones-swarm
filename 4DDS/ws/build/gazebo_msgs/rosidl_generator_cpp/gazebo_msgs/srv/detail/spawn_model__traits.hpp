  ...
  std::ostream & out)
{
  ...
  {
    out << "model_xml: ";
    rosidl_generator_traits::value_to_yaml(msg.model_xml, out);
    out << ", ";
  }
...
inline void to_yaml(
  const gazebo_msgs::srv::SpawnModel_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const gazebo_msgs::srv::SpawnModel_Request & msg)
{
...
[[deprecated("use gazebo_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const gazebo_msgs::srv::SpawnModel_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  gazebo_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use gazebo_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const gazebo_msgs::srv::SpawnModel_Response & msg)
{
  return gazebo_msgs::srv::to_yaml(msg);
}
