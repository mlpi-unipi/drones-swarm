...
#ifndef GAZEBO_MSGS__SRV__DETAIL__DELETE_MODEL__TRAITS_HPP_
#define GAZEBO_MSGS__SRV__DETAIL__DELETE_MODEL__TRAITS_HPP_
...
inline void to_yaml(
  const gazebo_msgs::srv::DeleteModel_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const gazebo_msgs::srv::DeleteModel_Request & msg)
{
...
template<>
inline const char * name<gazebo_msgs::srv::DeleteModel_Request>()
{
  return "gazebo_msgs/srv/DeleteModel_Request";
}
...
template<>
struct is_message<gazebo_msgs::srv::DeleteModel_Request>
  : std::true_type {};
...
[[deprecated("use gazebo_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const gazebo_msgs::srv::DeleteModel_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  gazebo_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use gazebo_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const gazebo_msgs::srv::DeleteModel_Response & msg)
{
  return gazebo_msgs::srv::to_yaml(msg);
}
...
template<>
inline const char * name<gazebo_msgs::srv::DeleteModel_Response>()
{
  return "gazebo_msgs/srv/DeleteModel_Response";
}
...
template<>
struct is_message<gazebo_msgs::srv::DeleteModel_Response>
  : std::true_type {};
...
template<>
inline const char * name<gazebo_msgs::srv::DeleteModel>()
{
  return "gazebo_msgs/srv/DeleteModel";
}
...
template<>
struct is_service<gazebo_msgs::srv::DeleteModel>
  : std::true_type
{
};

template<>
struct is_service_request<gazebo_msgs::srv::DeleteModel_Request>
  : std::true_type
{
};

template<>
struct is_service_response<gazebo_msgs::srv::DeleteModel_Response>
  : std::true_type
{
};
...
#endif  // GAZEBO_MSGS__SRV__DETAIL__DELETE_MODEL__TRAITS_HPP_
