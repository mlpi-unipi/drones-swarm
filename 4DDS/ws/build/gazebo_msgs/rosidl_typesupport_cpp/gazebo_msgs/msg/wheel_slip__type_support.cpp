...
static const _WheelSlip_type_support_symbol_names_t _WheelSlip_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gazebo_msgs, msg, WheelSlip)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gazebo_msgs, msg, WheelSlip)),
  }
};
...
{
  return &::gazebo_msgs::msg::rosidl_typesupport_cpp::WheelSlip_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gazebo_msgs, msg, WheelSlip)() {
  return get_message_type_support_handle<gazebo_msgs::msg::WheelSlip>();
}
