  ...
  gazebo_msgs__srv__BodyRequest_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    gazebo_msgs__srv__BodyRequest_Request * data =
      (gazebo_msgs__srv__BodyRequest_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!gazebo_msgs__srv__BodyRequest_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          gazebo_msgs__srv__BodyRequest_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  gazebo_msgs__srv__BodyRequest_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    gazebo_msgs__srv__BodyRequest_Response * data =
      (gazebo_msgs__srv__BodyRequest_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!gazebo_msgs__srv__BodyRequest_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          gazebo_msgs__srv__BodyRequest_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
