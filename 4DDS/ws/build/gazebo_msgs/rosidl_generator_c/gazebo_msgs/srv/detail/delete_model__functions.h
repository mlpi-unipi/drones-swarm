...
#ifndef GAZEBO_MSGS__SRV__DETAIL__DELETE_MODEL__FUNCTIONS_H_
#define GAZEBO_MSGS__SRV__DETAIL__DELETE_MODEL__FUNCTIONS_H_
 ...
 * calls
 * gazebo_msgs__srv__DeleteModel_Request__init().
...
/**
 * It calls
 * gazebo_msgs__srv__DeleteModel_Request__fini()
...
/**
 * It calls
 * gazebo_msgs__srv__DeleteModel_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gazebo_msgs__srv__DeleteModel_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gazebo_msgs
...
/**
 * It calls
 * gazebo_msgs__srv__DeleteModel_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_gazebo_msgs
...
/**
 * It calls
 * gazebo_msgs__srv__DeleteModel_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GAZEBO_MSGS__SRV__DETAIL__DELETE_MODEL__FUNCTIONS_H_
