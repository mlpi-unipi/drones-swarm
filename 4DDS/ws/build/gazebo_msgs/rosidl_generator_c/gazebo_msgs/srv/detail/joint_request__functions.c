...
bool
gazebo_msgs__srv__JointRequest_Request__are_equal(const gazebo_msgs__srv__JointRequest_Request * lhs, const gazebo_msgs__srv__JointRequest_Request * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
gazebo_msgs__srv__JointRequest_Request__copy(
  const gazebo_msgs__srv__JointRequest_Request * input,
  gazebo_msgs__srv__JointRequest_Request * output)
{
  if (!input || !output) {
    return false;
  }
...
gazebo_msgs__srv__JointRequest_Request__create()
{
  ...
  gazebo_msgs__srv__JointRequest_Request * msg = (gazebo_msgs__srv__JointRequest_Request *)allocator.allocate(sizeof(gazebo_msgs__srv__JointRequest_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
gazebo_msgs__srv__JointRequest_Request__Sequence__init(gazebo_msgs__srv__JointRequest_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (gazebo_msgs__srv__JointRequest_Request *)allocator.zero_allocate(size, sizeof(gazebo_msgs__srv__JointRequest_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gazebo_msgs__srv__JointRequest_Request__Sequence * array = (gazebo_msgs__srv__JointRequest_Request__Sequence *)allocator.allocate(sizeof(gazebo_msgs__srv__JointRequest_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
gazebo_msgs__srv__JointRequest_Request__Sequence__are_equal(const gazebo_msgs__srv__JointRequest_Request__Sequence * lhs, const gazebo_msgs__srv__JointRequest_Request__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!gazebo_msgs__srv__JointRequest_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
gazebo_msgs__srv__JointRequest_Request__Sequence__copy(
  const gazebo_msgs__srv__JointRequest_Request__Sequence * input,
  gazebo_msgs__srv__JointRequest_Request__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(gazebo_msgs__srv__JointRequest_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    gazebo_msgs__srv__JointRequest_Request * data =
      (gazebo_msgs__srv__JointRequest_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!gazebo_msgs__srv__JointRequest_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          gazebo_msgs__srv__JointRequest_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!gazebo_msgs__srv__JointRequest_Request__copy(
...
bool
gazebo_msgs__srv__JointRequest_Response__are_equal(const gazebo_msgs__srv__JointRequest_Response * lhs, const gazebo_msgs__srv__JointRequest_Response * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
gazebo_msgs__srv__JointRequest_Response__copy(
  const gazebo_msgs__srv__JointRequest_Response * input,
  gazebo_msgs__srv__JointRequest_Response * output)
{
  if (!input || !output) {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gazebo_msgs__srv__JointRequest_Response * msg = (gazebo_msgs__srv__JointRequest_Response *)allocator.allocate(sizeof(gazebo_msgs__srv__JointRequest_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
gazebo_msgs__srv__JointRequest_Response__Sequence__init(gazebo_msgs__srv__JointRequest_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (gazebo_msgs__srv__JointRequest_Response *)allocator.zero_allocate(size, sizeof(gazebo_msgs__srv__JointRequest_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gazebo_msgs__srv__JointRequest_Response__Sequence * array = (gazebo_msgs__srv__JointRequest_Response__Sequence *)allocator.allocate(sizeof(gazebo_msgs__srv__JointRequest_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
gazebo_msgs__srv__JointRequest_Response__Sequence__are_equal(const gazebo_msgs__srv__JointRequest_Response__Sequence * lhs, const gazebo_msgs__srv__JointRequest_Response__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!gazebo_msgs__srv__JointRequest_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
gazebo_msgs__srv__JointRequest_Response__Sequence__copy(
  const gazebo_msgs__srv__JointRequest_Response__Sequence * input,
  gazebo_msgs__srv__JointRequest_Response__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(gazebo_msgs__srv__JointRequest_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    gazebo_msgs__srv__JointRequest_Response * data =
      (gazebo_msgs__srv__JointRequest_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!gazebo_msgs__srv__JointRequest_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          gazebo_msgs__srv__JointRequest_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!gazebo_msgs__srv__JointRequest_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
