...
gazebo_msgs__srv__SetPhysicsProperties_Request__create()
{
  ...
  gazebo_msgs__srv__SetPhysicsProperties_Request * msg = (gazebo_msgs__srv__SetPhysicsProperties_Request *)allocator.allocate(sizeof(gazebo_msgs__srv__SetPhysicsProperties_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
gazebo_msgs__srv__SetPhysicsProperties_Request__Sequence__init(gazebo_msgs__srv__SetPhysicsProperties_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (gazebo_msgs__srv__SetPhysicsProperties_Request *)allocator.zero_allocate(size, sizeof(gazebo_msgs__srv__SetPhysicsProperties_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gazebo_msgs__srv__SetPhysicsProperties_Request__Sequence * array = (gazebo_msgs__srv__SetPhysicsProperties_Request__Sequence *)allocator.allocate(sizeof(gazebo_msgs__srv__SetPhysicsProperties_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
gazebo_msgs__srv__SetPhysicsProperties_Request__Sequence__are_equal(const gazebo_msgs__srv__SetPhysicsProperties_Request__Sequence * lhs, const gazebo_msgs__srv__SetPhysicsProperties_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!gazebo_msgs__srv__SetPhysicsProperties_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  gazebo_msgs__srv__SetPhysicsProperties_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(gazebo_msgs__srv__SetPhysicsProperties_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    gazebo_msgs__srv__SetPhysicsProperties_Request * data =
      (gazebo_msgs__srv__SetPhysicsProperties_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!gazebo_msgs__srv__SetPhysicsProperties_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          gazebo_msgs__srv__SetPhysicsProperties_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!gazebo_msgs__srv__SetPhysicsProperties_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gazebo_msgs__srv__SetPhysicsProperties_Response * msg = (gazebo_msgs__srv__SetPhysicsProperties_Response *)allocator.allocate(sizeof(gazebo_msgs__srv__SetPhysicsProperties_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
gazebo_msgs__srv__SetPhysicsProperties_Response__Sequence__init(gazebo_msgs__srv__SetPhysicsProperties_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (gazebo_msgs__srv__SetPhysicsProperties_Response *)allocator.zero_allocate(size, sizeof(gazebo_msgs__srv__SetPhysicsProperties_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  gazebo_msgs__srv__SetPhysicsProperties_Response__Sequence * array = (gazebo_msgs__srv__SetPhysicsProperties_Response__Sequence *)allocator.allocate(sizeof(gazebo_msgs__srv__SetPhysicsProperties_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
gazebo_msgs__srv__SetPhysicsProperties_Response__Sequence__are_equal(const gazebo_msgs__srv__SetPhysicsProperties_Response__Sequence * lhs, const gazebo_msgs__srv__SetPhysicsProperties_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!gazebo_msgs__srv__SetPhysicsProperties_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  gazebo_msgs__srv__SetPhysicsProperties_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(gazebo_msgs__srv__SetPhysicsProperties_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    gazebo_msgs__srv__SetPhysicsProperties_Response * data =
      (gazebo_msgs__srv__SetPhysicsProperties_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!gazebo_msgs__srv__SetPhysicsProperties_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          gazebo_msgs__srv__SetPhysicsProperties_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!gazebo_msgs__srv__SetPhysicsProperties_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
