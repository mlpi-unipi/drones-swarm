...
#ifndef GAZEBO_MSGS__SRV__DETAIL__SET_MODEL_STATE__FUNCTIONS_H_
#define GAZEBO_MSGS__SRV__DETAIL__SET_MODEL_STATE__FUNCTIONS_H_
...
/// Initialize srv/SetModelState message.
/**
...
/// Finalize srv/SetModelState message.
/**
...
/// Create srv/SetModelState message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gazebo_msgs__srv__SetModelState_Request__init().
...
/// Destroy srv/SetModelState message.
/**
 * It calls
 * gazebo_msgs__srv__SetModelState_Request__fini()
...
/// Check for srv/SetModelState message equality.
/**
...
/// Copy a srv/SetModelState message.
/**
...
/// Initialize array of srv/SetModelState messages.
/**
...
/// Finalize array of srv/SetModelState messages.
/**
 * It calls
 * gazebo_msgs__srv__SetModelState_Request__fini()
...
/// Create array of srv/SetModelState messages.
/**
 * It allocates the memory for the array and calls
 * gazebo_msgs__srv__SetModelState_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetModelState messages.
/**
 * It calls
 * gazebo_msgs__srv__SetModelState_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetModelState message array equality.
/**
...
/// Copy an array of srv/SetModelState messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gazebo_msgs__srv__SetModelState_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gazebo_msgs
...
/**
 * It calls
 * gazebo_msgs__srv__SetModelState_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_gazebo_msgs
...
/**
 * It allocates the memory for the array and calls
 * gazebo_msgs__srv__SetModelState_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gazebo_msgs
...
/**
 * It calls
 * gazebo_msgs__srv__SetModelState_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GAZEBO_MSGS__SRV__DETAIL__SET_MODEL_STATE__FUNCTIONS_H_
