...
bool gazebo_msgs__msg__entity_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_msgs.msg._entity_state.EntityState", full_classname_dest, 41) == 0);
  }
  gazebo_msgs__msg__EntityState * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of EntityState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_msgs.msg._entity_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EntityState");
