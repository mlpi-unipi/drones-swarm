...
bool gazebo_msgs__msg__model_states__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_msgs.msg._model_states.ModelStates", full_classname_dest, 41) == 0);
  }
  gazebo_msgs__msg__ModelStates * ros_message = _ros_message;
  {  // name
  ...
  {  // twist
    ...
    geometry_msgs__msg__Twist * dest = ros_message->twist.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of ModelStates */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_msgs.msg._model_states");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ModelStates");
