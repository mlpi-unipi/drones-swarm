...
bool gazebo_msgs__msg__model_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_msgs.msg._model_state.ModelState", full_classname_dest, 39) == 0);
  }
  gazebo_msgs__msg__ModelState * ros_message = _ros_message;
  {  // model_name
...
{
  /* NOTE(esteve): Call constructor of ModelState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_msgs.msg._model_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ModelState");
