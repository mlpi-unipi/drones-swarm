...
bool gazebo_msgs__msg__link_states__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_msgs.msg._link_states.LinkStates", full_classname_dest, 39) == 0);
  }
  gazebo_msgs__msg__LinkStates * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of LinkStates */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_msgs.msg._link_states");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LinkStates");
