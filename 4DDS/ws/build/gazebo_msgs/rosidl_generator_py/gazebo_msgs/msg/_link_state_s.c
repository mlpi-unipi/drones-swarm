...
bool gazebo_msgs__msg__link_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_msgs.msg._link_state.LinkState", full_classname_dest, 37) == 0);
  }
  gazebo_msgs__msg__LinkState * ros_message = _ros_message;
  {  // link_name
...
{
  /* NOTE(esteve): Call constructor of LinkState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_msgs.msg._link_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LinkState");
