...
bool gazebo_msgs__srv__get_physics_properties__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_msgs.srv._get_physics_properties.GetPhysicsProperties_Request", full_classname_dest, 68) == 0);
  }
  gazebo_msgs__srv__GetPhysicsProperties_Request * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of GetPhysicsProperties_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_msgs.srv._get_physics_properties");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetPhysicsProperties_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool gazebo_msgs__srv__get_physics_properties__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_msgs.srv._get_physics_properties.GetPhysicsProperties_Response", full_classname_dest, 69) == 0);
  }
  gazebo_msgs__srv__GetPhysicsProperties_Response * ros_message = _ros_message;
  {  // time_step
...
{
  /* NOTE(esteve): Call constructor of GetPhysicsProperties_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_msgs.srv._get_physics_properties");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetPhysicsProperties_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
