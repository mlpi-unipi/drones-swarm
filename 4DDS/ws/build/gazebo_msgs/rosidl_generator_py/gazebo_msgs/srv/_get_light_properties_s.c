...
bool gazebo_msgs__srv__get_light_properties__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_msgs.srv._get_light_properties.GetLightProperties_Request", full_classname_dest, 64) == 0);
  }
  gazebo_msgs__srv__GetLightProperties_Request * ros_message = _ros_message;
  {  // light_name
...
{
  /* NOTE(esteve): Call constructor of GetLightProperties_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_msgs.srv._get_light_properties");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetLightProperties_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool gazebo_msgs__srv__get_light_properties__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_msgs.srv._get_light_properties.GetLightProperties_Response", full_classname_dest, 65) == 0);
  }
  gazebo_msgs__srv__GetLightProperties_Response * ros_message = _ros_message;
  {  // diffuse
...
{
  /* NOTE(esteve): Call constructor of GetLightProperties_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_msgs.srv._get_light_properties");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetLightProperties_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
