...
bool gazebo_msgs__srv__get_link_state__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_msgs.srv._get_link_state.GetLinkState_Request", full_classname_dest, 52) == 0);
  }
  gazebo_msgs__srv__GetLinkState_Request * ros_message = _ros_message;
  {  // link_name
...
{
  /* NOTE(esteve): Call constructor of GetLinkState_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_msgs.srv._get_link_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetLinkState_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool gazebo_msgs__srv__get_link_state__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_msgs.srv._get_link_state.GetLinkState_Response", full_classname_dest, 53) == 0);
  }
  gazebo_msgs__srv__GetLinkState_Response * ros_message = _ros_message;
  {  // link_state
...
{
  /* NOTE(esteve): Call constructor of GetLinkState_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_msgs.srv._get_link_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetLinkState_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
