...
class Metaclass_SetEntityState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from gazebo_msgs.srv import _set_entity_state
...
class SetEntityState(metaclass=Metaclass_SetEntityState):
    from gazebo_msgs.srv._set_entity_state import SetEntityState_Request as Request
    from gazebo_msgs.srv._set_entity_state import SetEntityState_Response as Response
