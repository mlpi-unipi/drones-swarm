...
class Metaclass_GetLightProperties_Request(type):
    """Metaclass of message 'GetLightProperties_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_light_properties__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_light_properties__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_light_properties__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_light_properties__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_light_properties__request
...
class GetLightProperties_Request(metaclass=Metaclass_GetLightProperties_Request):
    """Message class 'GetLightProperties_Request'."""
...
class Metaclass_GetLightProperties_Response(type):
    """Metaclass of message 'GetLightProperties_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_light_properties__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_light_properties__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_light_properties__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_light_properties__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_light_properties__response
...
class GetLightProperties_Response(metaclass=Metaclass_GetLightProperties_Response):
    """Message class 'GetLightProperties_Response'."""
...
class Metaclass_GetLightProperties(type):
    """Metaclass of service 'GetLightProperties'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._TYPE_SUPPORT = module.type_support_srv__srv__get_light_properties

            from gazebo_msgs.srv import _get_light_properties
            if _get_light_properties.Metaclass_GetLightProperties_Request._TYPE_SUPPORT is None:
                _get_light_properties.Metaclass_GetLightProperties_Request.__import_type_support__()
            if _get_light_properties.Metaclass_GetLightProperties_Response._TYPE_SUPPORT is None:
                _get_light_properties.Metaclass_GetLightProperties_Response.__import_type_support__()


class GetLightProperties(metaclass=Metaclass_GetLightProperties):
    from gazebo_msgs.srv._get_light_properties import GetLightProperties_Request as Request
    from gazebo_msgs.srv._get_light_properties import GetLightProperties_Response as Response
