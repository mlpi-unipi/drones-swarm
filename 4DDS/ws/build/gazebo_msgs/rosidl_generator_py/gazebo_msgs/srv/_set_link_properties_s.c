...
bool gazebo_msgs__srv__set_link_properties__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_msgs.srv._set_link_properties.SetLinkProperties_Request", full_classname_dest, 62) == 0);
  }
  gazebo_msgs__srv__SetLinkProperties_Request * ros_message = _ros_message;
  {  // link_name
  ...
  {  // com
    ...
    if (!geometry_msgs__msg__pose__convert_from_py(field, &ros_message->com)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // gravity_mode
    PyObject * field = PyObject_GetAttrString(_pymsg, "gravity_mode");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->gravity_mode = (Py_True == field);
    Py_DECREF(field);
  }
  {  // mass
...
{
  /* NOTE(esteve): Call constructor of SetLinkProperties_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_msgs.srv._set_link_properties");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetLinkProperties_Request");
  ...
  {  // com
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose__convert_to_py(&ros_message->com);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // gravity_mode
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->gravity_mode ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "gravity_mode", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool gazebo_msgs__srv__set_link_properties__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gazebo_msgs.srv._set_link_properties.SetLinkProperties_Response", full_classname_dest, 63) == 0);
  }
  gazebo_msgs__srv__SetLinkProperties_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of SetLinkProperties_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gazebo_msgs.srv._set_link_properties");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetLinkProperties_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
