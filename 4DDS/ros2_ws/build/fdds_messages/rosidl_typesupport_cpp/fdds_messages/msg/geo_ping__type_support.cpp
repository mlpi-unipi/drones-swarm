...
static const _GeoPing_type_support_symbol_names_t _GeoPing_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fdds_messages, msg, GeoPing)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fdds_messages, msg, GeoPing)),
  }
};
...
{
  return &::fdds_messages::msg::rosidl_typesupport_cpp::GeoPing_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fdds_messages, msg, GeoPing)() {
  return get_message_type_support_handle<fdds_messages::msg::GeoPing>();
}
