...
bool px4_msgs__msg__trajectory_waypoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._trajectory_waypoint.TrajectoryWaypoint", full_classname_dest, 52) == 0);
  }
  px4_msgs__msg__TrajectoryWaypoint * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // point_valid
    ...
    ros_message->point_valid = (Py_True == field);
    Py_DECREF(field);
  }
  {  // type
...
{
  /* NOTE(esteve): Call constructor of TrajectoryWaypoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._trajectory_waypoint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrajectoryWaypoint");
  ...
  {  // point_valid
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->point_valid ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "point_valid", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
