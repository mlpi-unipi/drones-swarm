...
bool px4_msgs__msg__gpio_out__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._gpio_out.GpioOut", full_classname_dest, 30) == 0);
  }
  px4_msgs__msg__GpioOut * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of GpioOut */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._gpio_out");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GpioOut");
