...
bool px4_msgs__msg__parameter_set_value_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._parameter_set_value_request.ParameterSetValueRequest", full_classname_dest, 66) == 0);
  }
  px4_msgs__msg__ParameterSetValueRequest * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__parameter_set_value_request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ParameterSetValueRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._parameter_set_value_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ParameterSetValueRequest");
  ...
  px4_msgs__msg__ParameterSetValueRequest * ros_message = (px4_msgs__msg__ParameterSetValueRequest *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
