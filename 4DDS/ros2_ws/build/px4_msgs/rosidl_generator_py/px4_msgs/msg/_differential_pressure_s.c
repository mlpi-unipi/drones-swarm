...
bool px4_msgs__msg__differential_pressure__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._differential_pressure.DifferentialPressure", full_classname_dest, 56) == 0);
  }
  px4_msgs__msg__DifferentialPressure * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // differential_pressure_pa
    PyObject * field = PyObject_GetAttrString(_pymsg, "differential_pressure_pa");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->differential_pressure_pa = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // temperature
...
{
  /* NOTE(esteve): Call constructor of DifferentialPressure */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._differential_pressure");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DifferentialPressure");
  ...
  {  // differential_pressure_pa
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->differential_pressure_pa);
    {
      int rc = PyObject_SetAttrString(_pymessage, "differential_pressure_pa", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
