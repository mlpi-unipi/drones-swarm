...
bool px4_msgs__msg__buffer128__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._buffer128.Buffer128", full_classname_dest, 33) == 0);
  }
  px4_msgs__msg__Buffer128 * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of Buffer128 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._buffer128");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Buffer128");
