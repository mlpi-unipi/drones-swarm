...
bool px4_msgs__msg__gps_inject_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._gps_inject_data.GpsInjectData", full_classname_dest, 43) == 0);
  }
  px4_msgs__msg__GpsInjectData * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // len
    ...
    assert(PyLong_Check(field));
    ros_message->len = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // flags
...
{
  /* NOTE(esteve): Call constructor of GpsInjectData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._gps_inject_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GpsInjectData");
  ...
  {  // data
    ...
    memcpy(dst, src, 300 * sizeof(uint8_t));
    Py_DECREF(field);
  }
