  ...
  std::ostream & out)
{
  ...
  {
    out << "point_valid: ";
    rosidl_generator_traits::value_to_yaml(msg.point_valid, out);
    out << ", ";
  }
...
inline std::string to_yaml(const TrajectoryWaypoint & msg, bool use_flow_style = false)
{
