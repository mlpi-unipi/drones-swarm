...
static const _PowerButtonState_type_support_symbol_names_t _PowerButtonState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, PowerButtonState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, PowerButtonState)),
  }
};
...
{
  return &::px4_msgs::msg::rosidl_typesupport_cpp::PowerButtonState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4_msgs, msg, PowerButtonState)() {
  return get_message_type_support_handle<px4_msgs::msg::PowerButtonState>();
}
