...
static const _VehicleLandDetected_type_support_symbol_names_t _VehicleLandDetected_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, VehicleLandDetected)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, VehicleLandDetected)),
  }
};
...
{
  return &::px4_msgs::msg::rosidl_typesupport_cpp::VehicleLandDetected_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4_msgs, msg, VehicleLandDetected)() {
  return get_message_type_support_handle<px4_msgs::msg::VehicleLandDetected>();
}
