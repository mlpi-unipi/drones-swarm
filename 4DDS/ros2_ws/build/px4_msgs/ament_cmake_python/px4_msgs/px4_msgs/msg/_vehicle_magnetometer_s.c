...
bool px4_msgs__msg__vehicle_magnetometer__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._vehicle_magnetometer.VehicleMagnetometer", full_classname_dest, 54) == 0);
  }
  px4_msgs__msg__VehicleMagnetometer * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // magnetometer_ga
    PyObject * field = PyObject_GetAttrString(_pymsg, "magnetometer_ga");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 3;
      float * dest = ros_message->magnetometer_ga;
...
{
  /* NOTE(esteve): Call constructor of VehicleMagnetometer */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._vehicle_magnetometer");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleMagnetometer");
  ...
  {  // magnetometer_ga
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "magnetometer_ga");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    float * src = &(ros_message->magnetometer_ga[0]);
