...
bool px4_msgs__msg__follow_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._follow_target.FollowTarget", full_classname_dest, 40) == 0);
  }
  px4_msgs__msg__FollowTarget * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // est_cap
    PyObject * field = PyObject_GetAttrString(_pymsg, "est_cap");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->est_cap = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of FollowTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._follow_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FollowTarget");
  ...
  {  // est_cap
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->est_cap);
    {
      int rc = PyObject_SetAttrString(_pymessage, "est_cap", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
