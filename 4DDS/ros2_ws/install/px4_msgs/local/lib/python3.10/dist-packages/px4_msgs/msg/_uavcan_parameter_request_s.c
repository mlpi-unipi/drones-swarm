...
bool px4_msgs__msg__uavcan_parameter_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._uavcan_parameter_request.UavcanParameterRequest", full_classname_dest, 61) == 0);
  }
  px4_msgs__msg__UavcanParameterRequest * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of UavcanParameterRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._uavcan_parameter_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UavcanParameterRequest");
