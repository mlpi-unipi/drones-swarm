...
bool px4_msgs__msg__trajectory_bezier__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._trajectory_bezier.TrajectoryBezier", full_classname_dest, 48) == 0);
  }
  px4_msgs__msg__TrajectoryBezier * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of TrajectoryBezier */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._trajectory_bezier");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrajectoryBezier");
