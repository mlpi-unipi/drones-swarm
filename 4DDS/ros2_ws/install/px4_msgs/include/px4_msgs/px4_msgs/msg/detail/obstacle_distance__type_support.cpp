...
void fetch_function__ObstacleDistance__distances(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint16_t *>(
    get_const_function__ObstacleDistance__distances(untyped_member, index));
  auto & value = *reinterpret_cast<uint16_t *>(untyped_value);
  value = item;
}

void assign_function__ObstacleDistance__distances(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint16_t *>(
    get_function__ObstacleDistance__distances(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObstacleDistance_message_member_array[8] = {
  ...
  },
  {
    ...
    fetch_function__ObstacleDistance__distances,  // fetch(index, &value) function pointer
    assign_function__ObstacleDistance__distances,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "increment",  // name
