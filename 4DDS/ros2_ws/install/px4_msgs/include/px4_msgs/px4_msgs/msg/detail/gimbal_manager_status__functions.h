...
#ifndef PX4_MSGS__MSG__DETAIL__GIMBAL_MANAGER_STATUS__FUNCTIONS_H_
#define PX4_MSGS__MSG__DETAIL__GIMBAL_MANAGER_STATUS__FUNCTIONS_H_
 ...
 * calls
 * px4_msgs__msg__GimbalManagerStatus__init().
...
/**
 * It calls
 * px4_msgs__msg__GimbalManagerStatus__fini()
 ...
 * px4_msgs__msg__GimbalManagerStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * px4_msgs__msg__GimbalManagerStatus__Sequence__fini()
 * on the array,
...
#endif  // PX4_MSGS__MSG__DETAIL__GIMBAL_MANAGER_STATUS__FUNCTIONS_H_
