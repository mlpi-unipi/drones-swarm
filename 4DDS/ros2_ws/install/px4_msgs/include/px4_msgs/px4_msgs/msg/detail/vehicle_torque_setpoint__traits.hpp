...
inline void to_flow_style_yaml(
  const VehicleTorqueSetpoint & msg,
  std::ostream & out)
{
  out << "{";
  // member: timestamp
...
inline std::string to_yaml(const VehicleTorqueSetpoint & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const px4_msgs::msg::VehicleTorqueSetpoint & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4_msgs::msg::VehicleTorqueSetpoint & msg)
{
