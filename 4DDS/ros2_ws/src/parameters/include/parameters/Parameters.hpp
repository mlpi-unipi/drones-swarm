...
namespace fdds
{
    struct Parameters
    {
        ...
        float desiredRelativeDepth;  // Aggiunto
        ...
        explicit Parameters(const int controller_timer_ms,
                            ...
                            const float rel_depth,  // Aggiunto
                            ...
                            const float alignment_factor) : controllerTimerMs(controller_timer_ms),
                                                            ...
                                                            desiredRelativeDepth(rel_depth),  // Aggiunto
    ...
    inline Parameters loadOptions(bool verbose)
    {
        ...
        return Parameters(
            ...
            config_file["desiredRelativeDepth"].As<float>(),  // Aggiunto
